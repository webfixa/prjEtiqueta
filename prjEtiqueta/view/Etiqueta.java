...
public class Etiqueta extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLbCodBarras.setText("C�d.Barras: <F5>");
			...
			jLbDescricao.setText("Descri��o: <F4>");
			jLbItem = new JLabel();
				...
				public void keyTyped(java.awt.event.KeyEvent e) {
					if (jTfFilial.getText().equals("1")){
						...
						if (jTfFilial.getText().equals("2")){
							jTfFilial1.setText("RJ CONTRU��O");
							jTfItem.requestFocus();}
						else
							if (jTfFilial.getText().equals("3")){
								jTfFilial1.setText("PJ CAL�ADOS");
								jTfItem.requestFocus();}
				}
			});
		}
			...
			/*jCbDescricao.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyPressed(java.awt.event.KeyEvent e) {
					if (e.getKeyCode() == KeyEvent.VK_ENTER)
					{
						...
						}catch(Exception x){javax.swing.JOptionPane.showMessageDialog(null,"�tem inv�lido!");}
					}
				}
			});*/
	...
	private JComboBox getJCbTipoEtiqueta() {
		String tipo[] = {"eletro", "geral","gondola", "j�ias","roupas","suporte"};
