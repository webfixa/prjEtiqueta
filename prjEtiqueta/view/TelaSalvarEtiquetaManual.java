...
public class TelaSalvarEtiquetaManual {

	private JFrame frame;
	private JTextField textField;
	private String texto,qnt;
	 ...
	 */
			...
			public void run(String texto,String qnt) {
				try {
					TelaSalvarEtiquetaManual window = new TelaSalvarEtiquetaManual(texto, qnt);
	 ...
	 */
	public TelaSalvarEtiquetaManual() {
		initialize();
	}
	
	public TelaSalvarEtiquetaManual(String texto,String qnt) {
		this.texto = texto;
		this.qnt = qnt;
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblInformeONome = new JLabel("Informe o nome da etiqueta:");
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				malaDireta.salvarEtiquetaManual(textField.getText(), texto, qnt);
				frame.dispose();
			}
		});
