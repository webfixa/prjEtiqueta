...
public class TelaEscolherEtiquetaManual extends JFrame {
	...
	private int seq = 1;
	private ArrayList<EtiquetaManual> listas = new ArrayList<EtiquetaManual>();
	 ...
	 */
	public TelaEscolherEtiquetaManual() {
		super();
		initialize();
	}
	...
	private void initialize() {
		...
		this.setTitle("Emiss\u00E3o de Etiquetas - Escolher Etiqueta Manual");
			...
			JTfData.addKeyListener(new KeyAdapter() {
				...
				public void keyPressed(KeyEvent e) {
					if (e.getKeyCode() == KeyEvent.VK_ENTER) {
						...
						for (Iterator<EtiquetaManual> it = malaDireta.pegaEtiquetaData(
								JTfData.getText()).iterator(); it.hasNext();) {
							EtiquetaManual etiqueta = it.next();
							listas.add(etiqueta);
						}
						JTfData.setText("");
						...
						for (EtiquetaManual etiqueta : listas) {
							String[] linha = new String[3];// crio uma nova
															// linha para a
															// tabela com 5
															// elementos // TODO
															// Auto-generated
															// Event stub
															// actionPerformed()
							linha[0] = etiqueta.getCodigo();
							linha[1] = etiqueta.getNome();
							linha[2] = etiqueta.getTexto();
	...
	private JTable getJTbEtiquetas() {
		if (jTbEtiquetas == null) {
			...
			jTbEtiquetas.getColumn("Nome").setPreferredWidth(300);
			jTbEtiquetas.getColumn("Texto").setPreferredWidth(340);
